...
const Footer = () => {
  return (
<footer
className="flex flex-col items-center text-center bg-zinc-50 text-surface dark:bg-neutral-700 dark:text-white">
...
<div className="w-full p-4 text-center bg-black/5">
  © 2023 Copyright:
